...
class Sitemaster_Exportcategories_Block_Adminhtml_Category_Export_Categories extends Sitemaster_Exportcategories_Block_Adminhtml_Category_Export
{
	...
	public function getCsvData($opt = '') {
		if ($opt == 'all') {
			if (is_null($this->_csvData)) {
				$collection = Mage::getModel('sitemaster_coreexportcategories/attribute')->getCollection()
						->addCatalogEav()
			...
			return Mage::helper('sitemaster_coreexportcategories/category')->getAttributes();
		}
	}
