...
class Sitemaster_Exportcategories_Block_Adminhtml_Export extends Mage_Adminhtml_Block_Abstract
{
	...
	public function getScope($val) {
		$retarray = Mage::getModel('sitemaster_coreexportcategories/attribute')->getScopes();
		if (isset($retarray[$val])) return $retarray[$val];
		return $val;
	}

	public function getLayeredNavigation($val) {
		$retarray = Mage::getModel('sitemaster_coreexportcategories/attribute')->getLayeredNavigations();
		if (isset($retarray[$val])) return $retarray[$val];
		return $val;
	}

	public function getInputType($val) {
		$retarray = Mage::getModel('sitemaster_coreexportcategories/attribute')->getInputTypes();
		if (isset($retarray[$val])) return $retarray[$val];
		return $val;
	}

	public function getInputValidation($val) {
		$retarray = Mage::getModel('sitemaster_coreexportcategories/attribute')->getInputValidations();
		if (isset($retarray[$val])) return $retarray[$val];
		return $val;
	}
